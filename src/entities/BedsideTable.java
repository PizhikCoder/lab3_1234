...
public class BedsideTable extends Entity implements ICleanable, IContainable {
    private List<Entity> entities;

    public BedsideTable(String name, Entity ... entities) {
        super(name);
